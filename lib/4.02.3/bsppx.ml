...
let version = "5.0.6"
let header = 
   "// Generated by BUCKLESCRIPT 5.0.6 on nit, PLEASE EDIT WITH CARE"  
...
# 650 "syntax/reactjs_jsx_ppx.cppo.ml"
  (getLabel name, [], type_) :: types
    
# 652 "syntax/reactjs_jsx_ppx.cppo.ml"
    | _ -> types
  in
