...
function prepare() {
  // e(
  //   `hash hash js_of_ocaml 2>/dev/null || { echo >&2 "js_of_ocaml not found on path. Please install version 2.8.4 (although not with the buckelscript switch) and put it on your path."; exit 1; }`
  // );
...
var cmi_files = [
  ...
  .join(` `);
e(
  `js_of_ocaml --disable share --toplevel +toplevel.js +weak.js ./polyfill.js jsc.byte ${includes} ${cmi_files} -o ${playground}/exports.js`
);
